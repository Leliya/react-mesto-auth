...
function InfoTooltip({isOpen, onClose, message, isRegOk}){
  ...
  return(
    <div
      ...
      onClick={onClose}
    >
      <div className="popup__container popup__container_type_info" onClick={cancelClose}>
        <button
        ...
        <h2 className="popup__title popup__title_type_info">{isRegOk?"Вы успешно зарегистрированы!":message}</h2>
        </div>
        </div>
  )
}
